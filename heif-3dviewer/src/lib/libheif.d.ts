...
interface EmbindModule {
  ...
  heif_image_handle_has_depth_image(_0: heif_image_handle | null): number;
  ...
  heif_js_get_depth_imgs_decoded(_0: heif_image_handle | null): any;
  heif_js_depth_img_decode(_0: heif_image_handle | null, _1: number): any;
